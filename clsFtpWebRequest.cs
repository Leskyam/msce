...
Summary: This file implements the ftp:// protocol using the Pluggable protocol 
feature of System.Net namespace
  ...
  public class FtpWebRequest : WebRequest
  {
    ...
    public override WebResponse GetResponse() 
    {
      ...
      if(!DoLogin(user,pass)) 
        throw new ApplicationException("Inicio de sesión fallido\nRegistro del servidor:\n" + m_sbControlSocketLog.ToString());
    ...
    private void OpenDataConnection()
    {
      ...
      if( !resp_desc.PositiveCompletion )
      {
        ...
        throw new ApplicationException("Imposible abrir la conexión de datos\n" + ComposeExceptionMessage(resp_desc, m_sbControlSocketLog.ToString()));
      }
    }
    ...
    private void OpenControlConnection(Uri uriToConnect)
    {
      ...
      {
        throw new ProtocolViolationException("Conexión de control ya está en uso"); 
      }
